<?php 
	...
	//metodo post subir datos tabla programacion2022
	if($_SERVER['REQUEST_METHOD']==	'POST'){
			...
			foreach ($_POST as $clave=>$valor){
				...
				$ITEM=explode("_", $clave);//diviir el caracter
				//
				$IDNAME=strtolower($_SESSION['cod_user']);//converitr en minuscula
				//
				$query="UPDATE ". $tabla. " SET ".$ITEM[0]."="."$valor";
				$query.=" WHERE "."CPTO"."='".$ITEM[1]."' and usu='".$IDNAME."'";
				//debugear($query);
			...
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<?php	
							...
							echo '<td><input type="number" class="form-control" name="ITEM'.$id_mes.'_'.$rr['Cod_Pres_SES'].'" autocomplete="off" min="0" onchange="divProceso'.$divProceso.'(this.value);"
