		...
		<div style="width: 1780px;overflow-x: auto;white-space: nowrap;font-size:14px;">
			...
			<table class="table table-bordered table-hover">
				...
				<?php 
					...
					$ss=mysqli_query($conexion,"SELECT * FROM producto ORDER BY id LIMIT 11");
					while($rr=mysqli_fetch_array($ss)){
						
									}else{
							mysqli_query($conexion,"INSERT INTO ".$tabla." (CPTO,usu) VALUES ('".$rr['Descripcion_SES']."','".$_SESSION['cod_user']."')");
						}
